...
export type IconName = 'dashboard' | 'accounts' | 'platforms' | 'investments' | 'transactions' | 'receivables' | 'menu' | 'close' | 'plus' | 'edit' | 'delete' | 'wallet' | 'investment' | 'receivable-icon' | 'expense' | 'total-wealth' | 'transfer' | 'download' | 'logout' | 'assets';
...
const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  switch (name) {
    ...
    case 'transfer':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h18m-7.5-3.75L21 7.5m0 0L16.5 3M21 7.5H3" />
            </svg>
        );
    case 'platforms':
      return (
    ...
    case 'receivable-icon':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.826-1.106-2.251 0-3.078s2.953-.826 4.059 0c.995.74 1.722 1.96 1.722 3.255" />
        </svg>
      );
    case 'expense':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l.383-1.437M7.5 14.25V5.25A2.25 2.25 0 019.75 3h4.5A2.25 2.25 0 0116.5 5.25v9M7.5 14.25h-1.134a1.125 1.125 0 01-1.125-1.125V6.75A1.125 1.125 0 016.366 5.625h11.268a1.125 1.125 0 011.125 1.125v6.375a1.125 1.125 0 01-1.125 1.125H16.5" />
        </svg>
      );
    case 'total-wealth':
        return (
